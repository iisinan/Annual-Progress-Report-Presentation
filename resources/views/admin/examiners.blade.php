                ...
                <table class="table table-bordered table-hover" id="examinersTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('admin.users.reset-password', $examiner->id) }}" method="POST" class="reset-pw-form d-inline">
                                    @csrf
                                    <button type="submit" class="btn btn-sm btn-outline-warning" data-name="{{ $examiner->name }}" title="Reset Password"><i class="fa-solid fa-key"></i></button>
                                </form>

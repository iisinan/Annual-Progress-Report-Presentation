<x-app-layout>
    ...
    <div class="page-title-bar mb-4">
        ...
        <div class="d-flex gap-2">
            ...
            @else
                <a href="{{ route('student.upload') }}" class="btn btn-sm fw-bold" style="background:#f8b400;color:#145e27;border-radius:8px;"><i class="fa-solid fa-rotate me-1"></i> Resubmit PDF</a>
